...
class TestStewartEncoder(unittest.TestCase):
    ...
    def test_version_enforce(self):
        self.mock.return_value.read.return_value = bytes([0x55, 0xFC, 0x0, 0x0, 0x1, 0x0, 0x0, 0x0, 0x1, 0x0, 0xFF, 0x0, 0x0, 0x0, 0x0, 0x82, 0xD, 0xE5, 0x11])
