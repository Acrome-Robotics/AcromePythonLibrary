...
class TestStewart(unittest.TestCase):
    ...
    def test_read(self):
        ...
        self.mock.return_value.read.return_value = bytes([0x55, 0xBE, 0x32, 0x0, 0x3F, 0x0, 0x55, 0x0, 0x75, 0x0, 0xF4, 0x2, 0x89, 0xE, 0x9A, 0x99, 0xCC, 0x42, 0x9A, 0x19, 0x59, 0x43, 0x33, 0xF3, 0xB3, 0x43, 154, 153, 26, 67, 154, 153, 172, 194, 92, 143, 90, 65, 0, 0, 32, 63, 43, 135, 150, 63, 174, 71, 117, 193, 0x90, 0xC5, 0xF0, 0x59])
